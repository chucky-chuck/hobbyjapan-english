    ...
    <header style={{ background: '#111', borderBottom: '2px solid #c8a84b', padding: '0 24px' }}>
      <div className="header-inner">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <a
            href="https://hobbyjapan.co.jp/"
            target="_blank"
            rel="noopener noreferrer"
            className="header-corporate-link"
          >
            Japanese Site
          ...
          <SocialLink href="https://www.instagram.com/hobbyjapanenglish/" label="Instagram">
          ...
          <SocialLink href="https://twitter.com/hobbyjapan_eng" label="X (Twitter)">
            <svg viewBox="0 0 24 24" width={18} height={18} fill="#fff">
